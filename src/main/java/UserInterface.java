...
//        Customer newCustomer = new Customer();//usuniete

        System.out.print("First name: ");
        String firstName = scanner.nextLine();
//        newCustomer.setFirstName(firstName);//usuniete

        System.out.print("Last name: ");
        String lastName = scanner.nextLine();
//        newCustomer.setLastName(lastName);//usuniete
...
//        try {
//            String jsonString = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(newCustomer);
...
//        }
    ...
    private void addProductToRental() {
        ...
        List<Customer> borrowers = new ArrayList<>();

        //tworzę nowy produkt
        Product newProduct = new Product(productName, yearOfProduction, price, borrowers);
...
//        // Java objects to JSON string - pretty-print
//        try {
//            String jsonString = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(newProduct);
//            System.out.println(jsonString);
//
//            mapper.writeValue(new File("database.json"), newProduct);
//        } catch (com.fasterxml.jackson.core.JsonProcessingException jsonProcessingException) {
//            jsonProcessingException.printStackTrace();
//        } catch (IOException e) {
//            e.printStackTrace();
